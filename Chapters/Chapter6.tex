...
\begin{figure}%
    \centering
    \subfloat[4 sections merged, threshold 0.22]{{\includegraphics[width=7cm]{case1_cluster1.png} 
    \label{4merged}}}%
    \qquad
    \subfloat[3 sections merged, threshold 0.26]{{\includegraphics[width=5.5cm]{case1_cluster2.png}
    \label{3merged} }}%
