...
\begin{figure}[H]%
    \centering
    \subfloat[4 sections merged, threshold 0.22]{{\includegraphics[scale=0.7]{case1_cluster1.png} 
    \label{4merged}}}%
    \qquad
    \subfloat[3 sections merged, threshold 0.26]{{\includegraphics[scale=0.7]{case1_cluster2.png}
    \label{3merged} }}%
...
\begin{figure}[H]%
    \centering
    \subfloat[2 sections merged, threshold 0.05]{{\includegraphics[scale=0.6]{case2_cluster1.png} 
    \label{case2_2merged}}}%
    \qquad
    \subfloat[4 sections merged, threshold 0.09]{{\includegraphics[scale=0.6]{case2_cluster2.png}
    \label{case2_4merged} }}%
